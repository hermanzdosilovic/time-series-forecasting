...
public class MeanPercentageError extends AbstractFunction {
    private TDNN tdnn;
    private List<DataEntry> trainSet;

    public MeanPercentageError(TDNN tdnn, List<DataEntry> trainSet) {
    ...
    @Override public double getValue(RealVector realVector) {
        ...
        return DataUtil.calculateMeanPercentageError(tdnn, trainSet);
    }
